...
export function MetricsPagePassengersHour() {
	//

	//
	// A. Setup variables

	const t = useTranslations('metrics.MetricsPagePassengersHour');
	...
	if (!metricsByAgencyDayData || !metricsByAgencyDayData?.length) return null;
