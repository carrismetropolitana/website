...
export default function FrontendLinesToolbarFiltersLocality() {
	...
	return (
		<div className={styles.container}>
			<Select aria-label={t('label')} data={allLocalitiesDataFormatted} nothingFoundMessage={t('no_results')} onChange={handleSelectLocality} placeholder={t('placeholder')} radius="sm" size="md" value={FrontendLinesContext.entities.locality?.id || null} w="100%" clearable searchable />
		</div>
	);
