...
export default function FrontendFooterLogo() {
	...
	return (
		<div className={styles.container}>
			<Image alt="Logo da Carris Metropolitana" height={64} src="https://www.carrismetropolitana.pt/wp-content/themes/carrismetropolitana/images/carris-metropolitana-footer.svg" width={180} priority />
