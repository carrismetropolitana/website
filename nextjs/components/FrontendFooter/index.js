...
import FrontendFooterDebug from '@/components/FrontendFooterDebug';
import FrontendFooterVersion from '@/components/FrontendFooterVersion';
...
export default function Component() {
	...
	const t = useTranslations('FrontendFooter');
	...
	return (
		<footer className={styles.container}>
			...
			<div className={styles.sectionWrapper}>
				...
				<div className={styles.linksWrapper}>
					<FrontendFooterVersion className={styles.tertiaryLink} />
					<FrontendFooterDebug className={styles.tertiaryLink} />
				</div>
				<div className={styles.linksWrapper}>
