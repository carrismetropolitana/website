...
const FrontendVehiclesContext = createContext(null);
...
export function useFrontendVehiclesContext() {
	return useContext(FrontendVehiclesContext);
}
...
export function FrontendVehiclesContextProvider({ children }) {
	//
	...
	return <FrontendVehiclesContext.Provider value={contextObject}>{children}</FrontendVehiclesContext.Provider>;
