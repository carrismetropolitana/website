...
const VehiclesExplorerContext = createContext(null);
...
export function useVehiclesExplorerContext() {
  return useContext(VehiclesExplorerContext);
}
...
export function VehiclesExplorerContextProvider({ children }) {
  //
  ...
  return <VehiclesExplorerContext.Provider value={contextObject}>{children}</VehiclesExplorerContext.Provider>;
