...
import StopTimetableRow from '../StopsExplorerTimetableRow/StopsExplorerTimetableRow';
      ...
      {stopLoading || timetableLoading ? (
        ...
        <div className={styles.container}>
          ...
          <div className={styles.tableBody}>
            {timetableData.map((trip) => (
              <StopTimetableRow key={trip.trip_code} trip={trip} selectedTripCode={selectedTripCode} onSelectTrip={onSelectTrip} />
            ))}
          </div>
        </div>
      ) : (
