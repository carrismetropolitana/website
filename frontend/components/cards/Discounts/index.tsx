...
export const discounts: Discount[] = [
	...
	{
		description: 'Desconto de 75% para utilizadores com 65 ou mais anos. É necessário apresentar declaração de rendimentos. Válido apenas para a modalidade metropolitana. Saiba mais no site navegante.pt',
		metropolitan: '10 € / mês',
		municipal: 'N/A',
		name: '+65 B',
	},
	{
		description: 'Desconto de 100% para antigos combatentes com menos de 65 anos. É necessário apresentar declaração. Saiba mais no site navegante.pt',
		metropolitan: 'GRÁTIS',
		municipal: 'N/A',
		name: 'Antigo Combatente <65',
	},
	{
		description: 'Desconto de 30€ para antigos combatentes com 65 ou mais anos. É necessário apresentar declaração. Saiba mais no site navegante.pt',
		metropolitan: '10 € / mês',
		municipal: 'GRÁTIS',
		name: 'Antigo Combatente +65',
	},
