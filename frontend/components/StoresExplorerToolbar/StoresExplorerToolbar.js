...
import styles from './StoresExplorerToolbar.module.css';
...
export default function StoresExplorerToolbar({ selectedMapStyle, onSelectMapStyle, onMapRecenter, onOpenInGoogleMaps, selectedStopCode, onSelectStopCode }) {
  //

  //
  // A. Setup variables

  const t = useTranslations('StoresExplorerToolbar');
