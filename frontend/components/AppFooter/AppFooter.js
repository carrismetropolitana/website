...
export default function AppFooter() {
  ...
  return (
    <footer className={styles.container}>
      ...
      {/* <div className='site-bottom flex wide centered'> */}
      <div className={styles.bottomContent}>
        <div className={styles.copyright}>{t('copyright')}</div>
        <div className={styles.complaints}>
          <a target="_blank" href="https://www.livroreclamacoes.pt">
            <img src="https://www.carrismetropolitana.pt/wp-content/themes/carrismetropolitana/images/livro-reclamacoes.png" width="140" height="auto" />
          </a>
        </div>
        <div className={styles.legal}>
          <a rel="privacy-policy" href="https://www.carrismetropolitana.pt/politica-de-privacidade/">
            {t('privacy_policy')}
          </a>
          <a href="https://www.carrismetropolitana.pt/politica-de-cookies/">Política de Cookies</a>
          <a href="https://www.carrismetropolitana.pt/aviso-legal/">Aviso Legal</a>
        </div>
      </div>
    </footer>
  );
