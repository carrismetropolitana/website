...
export function Question1({ questionAnswer, stopId }: Props) {
	//
	...
	const [stopQuestion1Answer, setQuestion1Answer] = useState<string | undefined>(questionAnswer);
	...
	const handleQuestion1 = (e: React.MouseEvent<HTMLButtonElement>) => {
		...
		analyticsContext.actions.capture(ampli => ampli.stopsProbeAnswered({ question_1: value, question_title: t('stop|probe|question1'), stop_id: stopId }));
	};
