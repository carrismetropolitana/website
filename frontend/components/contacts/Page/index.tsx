	...
	return (
		<>
			...
			<Section childrenWrapperStyles={styles.section} withChildrenNudge={true} withChildrenPadding={true} withTopBorder={false} withTopPadding={false}>
				...
				<Button icon={<IconMessage size={18} />} label={t('by_form')} />
				<Button icon={<IconBrandWhatsapp size={18} />} label={t('by_whatsapp')} />
				<Button icon={<IconBrandInstagram size={18} />} label={t('by_instagram')} />
			</Section>
